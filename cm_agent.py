...
class Agent:
    ...
    def __init__(self, agent_entry, tags=None, modifyBones=None, freezeAnimation=False, geoGroup=None):
        preferences = bpy.context.user_preferences.addons[__package__].preferences
        if preferences.show_debug_options:
            t = time.time()
        self.id = agent_entry["blenderid"]
        self.brain = compileBrain(
            agent_entry["nodeGroup"], agent_entry["sim"], self.id, freezeAnimation)
        self.sim = agent_entry["sim"]
        ...
        self.rigOverwrite = agent_entry["rigOverwrite"]
        self.constrainBone = agent_entry["constrainBone"]
        self.modifyBones = {}
