...
translations = {
    'es': {
        ...
        ("*", "Simulation Start Frame"): "Spanish Here",
        ("*", "Simulation Etart Frame"): "Spanish Here",
        ...
        ("Operator", "Draw Directions"): "Spanish Here",
        # User Prefs
        ...
        ("*", "Event"): "Evento",
        ("*", "Time Multiplier"): "Spanish Here",
        ("*", "Sound Options"): "Spanish Here",
        ("*", "Position X"): "Spanish Here",
        ("*", "Position Y"): "Spanish Here",
        ("*", "Position Z"): "Spanish Here",
        ("*", "Shape Key Name"): "Spanish Here",
